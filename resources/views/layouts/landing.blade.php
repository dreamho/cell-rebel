...
<head>
    ...
    <title>Ericsson wireless ranking</title>
    ...
    <div class="container">
        ...
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav">
                ...
                <li><a href="#desc" class="smothscroll">User Reviews</a></li>
                <li><a href="#showcase" class="smothScroll">Data Description</a></li>
                <li><a href="#about" class="smothScroll">About US</a></li>
...
<div id="headerwrap">
    <div class="container">
        <div class="row centered">
            <div class="col-lg-12">
                <h1>{name} <b><a href="#">wireless-ranking</a></b></h1>
                <h3><a href="#">wireless ranking</a> aims to be the #1 global independent quality certifier for
                    <a href="#">mobile operators</a> developed by
                    <a href="#">{name}</a></h3>
