<div class="modal inmodal" id="reviewModal_{{str_replace(' ','_', $operator['mobileOperator'])}}" tabindex="-1" role="dialog" aria-hidden="true">
        ...
        <div class="modal-content animated bounceInRight">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    <p>Publish your view of your experience with <strong>{{$operator['mobileOperator']}}</strong></p>
